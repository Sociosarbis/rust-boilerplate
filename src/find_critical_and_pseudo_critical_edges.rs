...
mod tests {
  ...
  fn find_critical_and_pseudo_critical_edges_simple() {
    let suites = vec![
      Suite {
        n: 5,
        edges: t2_i![[0,1,1],[1,2,1],[2,3,2],[0,3,2],[0,4,3],[3,4,3],[1,4,6]],
        ret: t2_i![[0,1],[2,3,4,5]]
      },
      Suite {
        n: 4,
        edges: t2_i![[0,1,1],[1,2,1],[2,3,1],[0,3,1]],
        ret: t2_i![[],[0,1,2,3]]
      },
      Suite {
        n: 6,
        edges: t2_i![[0,1,1],[1,2,1],[0,2,1],[2,3,4],[3,4,2],[3,5,2],[4,5,2]],
        ret: t2_i![[3],[0,1,2,4,5,6]]
      }
    ];
